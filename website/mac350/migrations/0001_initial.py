# Generated by Django 3.0.7 on 2020-06-24 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tutor', models.ForeignKey(blank=True, db_column='id_tutor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Pessoa')),
            ],
            options={
                'db_table': 'pessoa',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_perfil', models.ForeignKey(db_column='id_perfil', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Perfil')),
                ('id_servico', models.ForeignKey(db_column='id_servico', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Servico')),
                ('id_usuario', models.ForeignKey(db_column='id_usuario', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Pessoa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_perfil', models.ForeignKey(db_column='id_perfil', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Perfil')),
                ('id_servico', models.ForeignKey(db_column='id_servico', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Servico')),
                ('id_tutor', models.ForeignKey(db_column='id_tutor', on_delete=django.db.models.deletion.DO_NOTHING, related_name='tutelamento_id_tutor', to='mac350.Pessoa')),
                ('id_usuario_tutelado', models.ForeignKey(db_column='id_usuario_tutelado', on_delete=django.db.models.deletion.DO_NOTHING, related_name='tutelamento_id_tutelado', to='mac350.Pessoa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_exame', models.ForeignKey(db_column='id_exame', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Exame')),
                ('id_paciente', models.ForeignKey(db_column='id_paciente', on_delete=django.db.models.deletion.DO_NOTHING, to='mac350.Pessoa')),
            ],
            options={
                'db_table': 'realiza',
                'managed': True,
